...
from thunder.backend_optimizer.optimizer import BackendOptimizer, OptimizerType, TraceType
...
def autotune_transform_for_execution(trace: TraceCtx, executors_list: Sequence[Executor], trace_type: TraceType, autotune_type: OptimizerType, cached_fw_trace: TraceCtx | None = None, visualizer: Visualizer | None = None) -> TraceCtx:
    ...
    backend_optimizer = BackendOptimizer(trace, executors_list, trace_type, cached_fw_trace=cached_fw_trace, produce_log=True, log_file_name=f'autotune_transform_for_execution_{sig_name}.log', visualizer=None, optimizer_type=autotune_type)
