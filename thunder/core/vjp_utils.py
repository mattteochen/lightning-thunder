...
def get_saved_for_backward_tensors(trace: TraceCtx) -> tuple[TensorProxy]:
    ...
    # The name is defined at
    # https://github.com/Lightning-AI/lightning-thunder/blob/681aef744786c85f925a590e6b5e6b5162932adf/thunder/core/transforms.py#L3643
    utils.check(
        getattr(trace.fn, "__name__", None) == "augmented_forward_fn",
        lambda: "The trace must be generated by Thunder's automatic differentiation",
    )
