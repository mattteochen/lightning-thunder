...
with torch.device("cuda"):
    ...
    jmodel_auto = thunder.jit(
        model, autotune_type="runtime", executors=["nvfuser", "cudnn", "sdpa", "fa3", "torchcompile"]
    )
